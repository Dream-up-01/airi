...
- Modify: `<external Fabric Mod workspace>/src/main/java/moe/airi/mcconnect/transport/DevicePairingKey.java`
- Modify: `<external Fabric Mod workspace>/src/main/java/moe/airi/mcconnect/transport/AiriProtocolCodec.java`
- Test: `<external Fabric Mod workspace>/src/test/java/moe/airi/mcconnect/transport/AiriProtocolCodecTest.java`
...
**Files:**
- Create: `<external Fabric Mod workspace>/src/main/java/moe/airi/mcconnect/session/ModuleInstanceId.java`
- Test: `<external Fabric Mod workspace>/src/test/java/moe/airi/mcconnect/session/ModuleInstanceIdTest.java`
- Modify: `<external Fabric Mod workspace>/src/main/java/moe/airi/mcconnect/AiriMcConnectController.java`
- Modify: `<external Fabric Mod workspace>/src/main/java/moe/airi/mcconnect/transport/AiriWebSocketClient.java`
...
**Files:**
- Create: `<external Fabric Mod workspace>/src/main/java/moe/airi/mcconnect/transport/ReconnectPolicy.java`
- Test: `<external Fabric Mod workspace>/src/test/java/moe/airi/mcconnect/transport/ReconnectPolicyTest.java`
- Modify: `<external Fabric Mod workspace>/src/main/java/moe/airi/mcconnect/AiriMcConnectController.java`
...
**Files:**
- Modify: `<external Fabric Mod workspace>/src/main/java/moe/airi/mcconnect/transport/DevicePairingKey.java`
- Create: `<external Fabric Mod workspace>/src/test/java/moe/airi/mcconnect/transport/DevicePairingKeyTest.java`
