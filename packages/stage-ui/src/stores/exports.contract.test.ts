...
describe('stage-ui exports contract', () => {
  it('keeps the exported subpath key set stable', () => {
    ...
    expect(Object.keys(exportsMap).sort()).toEqual([
      ...
      './constants',
      './constants/*',
      './domains/characterBook',
      './domains/characterSource',
      './domains/companion',
      './domains/localVoiceServices',
      './domains/minecraft-companion',
      './domains/perception',
      './domains/prompt',
      './domains/speechRouting',
      './domains/voiceConversation',
      './libs',
      './libs/*',
      './libs/inference',
      './libs/inference/adapters/*',
      './libs/minimax-voice-clone',
      './services/characterExtractor',
      './services/perception',
      './services/voice-runtime-diagnostics',
      './services/voice-runtime-quiesce',
      './services/voice-settings-sync',
      './stores',
      './stores/*',
      './stores/analytics',
      ...
      './stores/characterExtraction',
      './stores/characterSourceImport',
